			...
			<div id="wpoa-settings-section-login-with-slack" class="wpoa-settings-section">
				...
				<div class='form-padding'>
					...
					<p>
						<strong>Instructions:</strong>
					<ol>
						<li>Visit  <a href='https://api.slack.com/apps' target="_blank">https://api.slack.com/apps</a>.</li>
						<li>At Slack, create a new Project and make sure the Development Slack Team is set to the one wich users shoulb be able to login</li>
						<li>At Slack, OAuth & Permissions, provide your site's homepage URL (<?php echo $blog_url; ?>) for the new App's Redirect URI. Don't forget the trailing slash!</li>

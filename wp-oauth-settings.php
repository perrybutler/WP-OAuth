	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<table class='form-table'>
				...
				<tr valign='top'>
				<th scope='row'>Restrict to Organisation: (optional)</th>
				<td>
					<input type='text' name='wpoa_github_api_organisation' value='<?php echo get_option('wpoa_github_api_organisation'); ?>' />
				</td>
				</tr>
			</table> <!-- .form-table -->
			<p>
